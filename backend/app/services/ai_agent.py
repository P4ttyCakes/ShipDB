...
class AIAgentService:
    ...
    def _system_instruction(self) -> str:
        ...
        return (
            ...
            "\n\n"
            "COMPLETION STRATEGY - BE AGGRESSIVE: "
            "After 1-2 user responses, you MUST complete. "
            "Don't ask for every possible detail - generate a working database design "
            "based on the business domain and common patterns. "
            "It's ALWAYS better to generate a complete design than to ask more questions. "
            "\n\n"
            "FORCE COMPLETION EARLY: "
            "If the user has provided ANY information about their business, "
            "you MUST set done=true and generate complete entities immediately. "
            "Do not ask follow-up questions - create a working database design based on industry standards. "
            "\n\n"
            "COMPLETION TRIGGERS: "
            ...
            "- 'you decide' "
            "- 'up to you' "
            "Also set done=true if the user provides: business type, industry, or main operations. "
