...
class AIAgentService:
    ...
    def _system_instruction(self) -> str:
        ...
        return (
            ...
            '{"next_question": "Perfect! I have enough information to create your database design.", "done": true, "partial_spec": {"app_type": "Healthcare Management System", "db_type": "postgresql", "entities": [{"name": "patients", "fields": [{"name": "id", "type": "uuid", "required": true, "primary_key": true}, {"name": "name", "type": "string", "required": true}, {"name": "email", "type": "string", "required": true, "unique": true}, {"name": "phone", "type": "string", "required": false}, {"name": "date_of_birth", "type": "date", "required": false}, {"name": "created_at", "type": "timestamp", "required": true}]}, {"name": "doctors", "fields": [{"name": "id", "type": "uuid", "required": true, "primary_key": true}, {"name": "name", "type": "string", "required": true}, {"name": "specialty", "type": "string", "required": true}, {"name": "license_number", "type": "string", "required": true}, {"name": "email", "type": "string", "required": true, "unique": true}, {"name": "created_at", "type": "timestamp", "required": true}]}, {"name": "appointments", "fields": [{"name": "id", "type": "uuid", "required": true, "primary_key": true}, {"name": "patient_id", "type": "uuid", "required": true, "foreign_key": {"table": "patients", "field": "id"}}, {"name": "doctor_id", "type": "uuid", "required": true, "foreign_key": {"table": "doctors", "field": "id"}}, {"name": "appointment_date", "type": "timestamp", "required": true}, {"name": "status", "type": "string", "required": true}, {"name": "notes", "type": "text", "required": false}]}]}}'
            "\n\n"
